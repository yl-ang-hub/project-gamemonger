        ...
        <div className="mx-2 my-3" id="userLists">
          ...
          >
            ...
            <div className="row mb-3 px-2">
              ...
              >
                Add List className="col-sm-1 btn btn-outline-success fs-5 mx-1"
                style={{ height: "50px", width: "50px" }}
                onClick={() => setShowAddListModal(true)}
                data-toggle="tooltip" title="Add new list">
                <IoMdAddCircle />
              </button>
              ...
              >
                Rename List className="col-sm-1 btn btn-outline-primary fs-5
                mx-1" style={{ height: "50px", width: "50px" }}
                onClick={() => setShowRenameListModal(true)}
                data-toggle="tooltip" title="Rename my list">
                <BiRename />
              </button>
              ...
              >
                Delete List className="col-sm-1 btn btn-outline-danger fs-6
                mx-1" style={{ height: "50px", width: "50px" }}
                onClick={() => setShowDeleteListModal(true)}
                data-toggle="tooltip" title="Delete my list">
                <FaTrash />
              </button>
            </div>
